...
spanishMessage (ConfirmationEmailSent email) =
    "Una confirmación de correo electrónico a sido enviada a " `mappend`
    email `mappend`
    "."
spanishMessage AddressVerified = "Dirección verificada, por favor cree una contraseña"
...
spanishMessage PasswordResetPrompt = "Digite su cuenta de correo o nombre de usuario, y una confirmación de actualización de contraseña será enviada a su cuenta de correo."
