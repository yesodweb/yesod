...
dutchMessage PasswordResetTitle = "Password Reset"
...
dutchMessage PasswordResetPrompt = "Voer uw e-mailadres of gebruikersnaam hieronder in, er zal een wachtwoord reset e-mail naar u worden verzonden."
