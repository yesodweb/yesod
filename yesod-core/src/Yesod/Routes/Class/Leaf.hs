...
-- | Generated by the full-site data splice for each endpoint-owning fragment.
-- This structural lookup requires no authorization instances.
class HasRouteLeaves fragment => LookupRouteLeaves fragment where
    -- | Recover a selected fragment's own leaves and parent captures. Returns
    -- 'Nothing' for every other fragment, including descendants of this one.
    lookupRouteLeaves
        :: SomeRouteLeaf (ParentSite fragment)
        -> Maybe (ParentArgs fragment, RouteLeaves fragment)
...
withRouteLeaf matched callback =
    case selectRouteLeaf matched of
