...
import Yesod.Core.Handler (HandlerFor, getRequest, invalidArgs, redirect, selectRep, provideRep, rawRequestBody, ProvidedRep, lookupHeader, hasJsonContentType)
...
parseCheckJsonBody = do
    ...
    case e of
        Right _   -> parseInsecureJsonBody
        Left  mct -> return $ J.Error $ "Non-JSON content type: " ++ show mct
