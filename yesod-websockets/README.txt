...
REQUIRED MODULES:
chat.hs requires two modules which are not part of yesod-websockets: stm-lifted and conduit-combinators. yesod-websockets can be installed with the command "cabal install". The additional modules can be installed with the command, "cabal install stm-lifted conduit-combinators".
